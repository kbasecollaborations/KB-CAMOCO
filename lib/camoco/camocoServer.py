...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'camoco'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from camoco.camocoImpl import camoco  # noqa @IgnorePep8
impl_camoco = camoco(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'camoco'
